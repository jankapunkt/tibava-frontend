...
<br /><br />
            ...
            <div id="modalDiv" class="modal">
                <div class="modal-content">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="text-right"><button class="btn btn-primary" v-on:click="onFormCancel">X</button></div>             
                        </div>
                    </div>
                    <div class="row">
                    ...
                    v-on:init="handleFilePondInit"/>
                        ...
                        <div class="col-sm-12">
                            <div id="upload_form_2">
                                ...
                                -->
                                <div class="form-group row">
                                    <label for="authorName" class="col-sm-2 col-form-label">User</label>
                                    <div class="col-sm-10">
                                        <input class="form-control" id="authorName" placeholder="Your User Name" />
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="licence" class="col-sm-2 col-form-label">License</label>
                                    <div class="col-sm-10">
                            ...
                            <form id="upload_form" class="file-upload-form" enctype="multipart/form-data">
                                <div class="col-sm-12">
                                    <input type="file" name="file1" id="file1" @change="uploadFile" accept="video/*" />
                                    <br />
                                    <progress id="progressBar" value="0" max="100" style="width: 100%; color: #af1414" ></progress>
                                    <h3 id="status"></h3>
                            ...
                            <div class="col-sm-6">
                                <div class="text-right"><button class="btn btn-primary" v-on:click="onFormCancel">Cancel</button></div>             
                            </div>
                    </div>
                        </div>
                    </div>
                    ...
                    <tbody>
                        ...
                        <tr v-for="vid in videos" :key="vid[0]" class="border-down" height="40px">
                            ...
                            <th class="text-align-left">
                                <a href="#" v-on:click="processVideo(vid[0], vid[10])">Process</a>
                                |
            ...
            <br /><br />
            <div class="row">
                <button class="btn btn-info" @click="showModal" style="width: 100%; background-color: #4CAF50;; color: #ffffff" >Upload New Video</button>
            </div>
        </div>
    </div>
