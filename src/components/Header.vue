<template>
    <div>
        <div class="topnav vertical-align-middle" id="myTopnav">
                 ...
                 <div class="text-align-left">
                    <div class="w3-sidebar w3-bar-block w3-border-right" style="display:none" id="mySidebar">
                        ...
                        <div id="meanuAccordion0" class="w3-hide w3-white w3-card">
                            <a href="#" class="w3-bar-item w3-button" v-on:click="openModalVideoList()">Uploaded Videos</a>
                            <a href="#" class="w3-bar-item w3-button"><router-link to="/" class="">Video Analysis</router-link></a>
                            <a href="#" class="w3-bar-item w3-button"><router-link to="/upload" class="">Upload New Video</router-link></a>
                        </div>
                        ...
                        <div id="meanuAccordion1" class="w3-hide w3-white w3-card">
                            ...
                            <a href="#" class="w3-bar-item w3-button">Annotation Categories</a>
                        </div>
            ...
            <a href="#" class="logo-icon"><img class="tibava-logo" src="./../assets/tib_tibava_logo_5.png" alt="TIB-AV-A" /></a>
            <a href="#" class="logo-text"><h2 class="pd-lg-txt">TIB AV-Analytics</h2></a>
