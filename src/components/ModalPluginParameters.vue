  ...
  <div>
    <template v-for="parameter in parameters">
      ...
      <v-select v-model="parameter.value" :items="shot_timelines" :label="parameter.text" :hint="parameter.hint"
        item-text="name" item-value="id" v-if="parameter.field == 'select_timeline' && shot_timelines.length > 0"
      ...
      <div v-if="parameter.field == 'image_input'" :key="parameter.name">
        <v-file-input v-model="parameter.file" :label="parameter.text" :hint="parameter.hint" persistent-hint filled
