...
const api = {
  ...
  actions: {
    async create({ commit }, { timelineSegmentId, annotationId }) {
      ...
      console.log(
        `TIMELINE_SEGMENT_ANNOTATION_CREATE ${JSON.stringify(params)}`
      );
      return axios
        .post(
    ...
    async toggle({ commit }, { timelineSegmentId, annotationId }) {
      const params = {
        timeline_segment_id: timelineSegmentId,
        annotation_id: annotationId,
      };
      console.log(`timelineSegmentId ${timelineSegmentId}`);
