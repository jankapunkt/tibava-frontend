...
const api = {
    ...
    actions: {
        async create({ commit }, { name, color, categoryId, videoId=null }) {
            ...
            return axios.post(`${config.API_LOCATION}/annotation/create`, params)
                .then((res) => {
        ...
        async change({ commit }, { annotationId, name, color, categoryId }) {
            ...
            return axios.post(`${config.API_LOCATION}/annotation/update`, params)
                .then((res) => {
        ...
        async listUpdate({ commit }, {videoId = null}) {
            ...
            return axios.get(`${config.API_LOCATION}/annotation/list`, {params})
                .then((res) => {
                    if (res.data.status === 'ok') {
